...
var WorkerImage = module.exports = new Class({
    ...
    , crop : function(options){
        ...
        this._checkAndApplyConstraints(top, left, height, width);
    ...
    , _checkAndApplyConstraints: function(top, left, height, width){
        if(top + height > this.height || left + width > this.width){
