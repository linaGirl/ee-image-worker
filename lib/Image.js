 ...
 *
 * @todo: properly reflect the mimetype conversions
...
var Image = module.exports = new Class({
    ...
    , focusOn: function focusOn(focus){
        ...
        return focusOn.call(this, focus);
    }
